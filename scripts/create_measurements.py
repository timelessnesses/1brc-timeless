...
# with some edits to make it work on 1brc-timeless repository by timelessnesses (using this in CI)
...
def build_weather_station_name_list():
    ...
    """
    station_names = []
    with open('./scripts/weather_stations.csv', 'r', encoding="utf-8") as file:
